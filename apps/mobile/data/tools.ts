...
export const mobileTools: MobileTool[] = [
  ...
  { id: 'document-ai', name: 'Document AI', description: 'Summarize, extract, ask questions and rewrite text documents.', category: 'AI', plan: 'Free', icon: 'file-document-outline', route: '/tools/document-ai', status: 'native' },
