    ...
    <AuthLayout onBack={onBack}>
      {sent ? (
        <div className="text-center py-4">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">{l('Check your email')}</h1>
          <p className="text-gray-400 text-sm mb-6">
            {l("We've sent a password reset link to")} <span className="text-white font-medium">{email}</span>.
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              ...
              {l(loading ? 'Sending...' : 'Send Reset Link')}
            </button>
          </form>
