...
function PrivacyTab({ toast }: { toast: ReturnType<typeof useToast> }) {
  ...
  async function handleDeleteAccount() {
    ...
    try {
      ...
      toast.update(toastId, 'Failed to delete account. Please contact support.', 'error');
    }
    setDeleting(false);
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-white font-semibold">Data Export (GDPR)</h3>
        </div>
        <p className="text-gray-500 text-sm mb-4">Download a complete copy of all your data stored on Tayar Intelligence Tools. This includes your profile, projects, files, conversations, and activity log.</p>
      ...
      <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-white font-semibold">Privacy Controls</h3>
        </div>
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div>
              <div className="text-white text-sm font-medium">Analytics Tracking</div>
              <div className="text-gray-500 text-xs">Help us improve by sharing anonymous usage data</div>
            </div>
            <button
              onClick={() => {
                ...
                toast.success(newVal ? 'Analytics enabled' : 'Analytics disabled');
              }}
          ...
          <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div>
              <div className="text-white text-sm font-medium">AI Training Opt-Out</div>
              <div className="text-gray-500 text-xs">Prevent your content from being used to improve AI models</div>
            </div>
            <button
              onClick={() => {
                ...
                toast.success(newVal ? 'AI training opt-out enabled' : 'AI training opt-out disabled');
              }}
          ...
          <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div>
              <div className="text-white text-sm font-medium">Data Storage Location</div>
              <div className="text-gray-500 text-xs">Your data is stored in EU (Stockholm) servers</div>
            </div>
            <Check className="w-4 h-4 text-emerald-400" />
          </div>
          <div className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5">
            <div>
              <div className="text-white text-sm font-medium">Data Encryption</div>
              <div className="text-gray-500 text-xs">All data is encrypted in transit and at rest</div>
            </div>
            <Check className="w-4 h-4 text-emerald-400" />
          </div>
        </div>
      ...
      <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-6">
        ...
        <p className="text-gray-500 text-sm mb-4">Permanently delete your account and all associated data — projects, files, conversations, and activity. This action cannot be undone.</p>
        {!confirmDelete ? (
          ...
          <div className="space-y-4">
            <div className="bg-red-500/5 border border-red-500/10 rounded-xl p-4">
              ...
              <ul className="text-gray-500 text-xs space-y-1 ml-4 list-disc">
                ...
                <li>All projects (CVs, cover letters, documents)</li>
                <li>All files and exports</li>
                <li>All AI conversations and usage history</li>
                <li>All activity logs and preferences</li>
              </ul>
            </div>
            <div>
              <label className="text-gray-400 text-xs font-medium mb-1.5 block">Type <span className="text-red-400 font-mono">DELETE</span> to confirm</label>
              <input
...
function ProfileTab({
  ...
  async function handleSave() {
    ...
    if (err) {
      ...
      toast.update(toastId, 'Profile saved', 'success');
    }
    setSaving(false);
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h3 className="text-white font-semibold">{fullName || 'Your Name'}</h3>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="text-gray-400 text-xs font-medium mb-1.5 block uppercase tracking-wider">Bio</label>
            <textarea
              value={bio}
...
function SecurityTab({
  ...
  async function handleChangePassword() {
    ...
    if (err) {
      ...
      toast.update(toastId, 'Password updated successfully', 'success');
      setCurrentPassword('');
      setNewPassword('');
      setConfirmPassword('');
    }
    ...
    <div className="space-y-6">
          ...
          {user?.email_confirmed_at ? (
            <>
              ...
              <div>
                ...
                <p className="text-gray-500 text-xs">Your email address has been confirmed.</p>
              </div>
            </>
          ) : (
            <>
              ...
              <div className="flex-1">
                <p className="text-white text-sm font-medium">Email not verified</p>
                <p className="text-gray-500 text-xs">Please verify your email address to secure your account.</p>
              </div>
              <button
                onClick={async () => {
                  ...
                  else toast.update(toastId, 'Verification email sent', 'success');
                }}
      ...
      <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="text-gray-400 text-xs font-medium mb-1.5 block uppercase tracking-wider">Confirm New Password</label>
            <input
              type={showPasswords ? 'text' : 'password'}
      ...
      <div className="bg-red-500/5 border border-red-500/20 rounded-2xl p-6">
        ...
        <p className="text-gray-500 text-sm mb-4">Sign out from all devices or permanently delete your account.</p>
        <div className="flex gap-3">
          <button
            onClick={signOut}
          ...
          {(['dark', 'light'] as Theme[]).map(t => (
            ...
            >
              ...
              <div className="text-left">
                <div className="text-white text-sm font-medium capitalize">{t} Mode</div>
                <div className="text-gray-500 text-xs">{t === 'dark' ? 'Easy on the eyes' : 'Bright and clean'}</div>
              </div>
