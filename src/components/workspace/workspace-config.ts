...
export type ViewId =
  ...
  | 'feedback' | 'bug-report' | 'activity-timeline' | 'invoice-generator' | 'templates-hub' | 'name-generator' | 'letter-generator' | 'prompt-library' | 'batch-image-tools' | 'image-cropper' | 'background-remover';
