...
console.log('NAVBAR LANGUAGE TEST:', {
  home: t('nav.home'),
  tools: t('nav.tools'),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <a
              href="#"
              className="text-white text-sm px-4 py-2 border-b-2 border-violet-500 font-medium"
            >
              {t('nav.home')}
            </a>
            ...
            <a
              href="#business"
              className="text-gray-300 text-sm px-4 py-2 hover:text-white transition-colors"
            >
              {t('nav.business')}
            </a>
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-violet-600 hover:bg-violet-500 text-white text-sm font-semibold px-5 py-2 rounded-lg transition-colors"
            >
              {t('nav.signup')}
      ...
      {mobileOpen && (
        <div className="md:hidden bg-[#0a0a1a] border-t border-white/5 px-4 py-4 flex flex-col gap-2">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              onClick={onLogin}
              className="flex-1 text-sm text-white border border-white/20 rounded-lg py-2"
            >
              {t('nav.login')}
            </button>
            ...
            <button
              onClick={onGetStarted}
              className="flex-1 text-sm bg-violet-600 text-white rounded-lg py-2 font-semibold"
            >
              {t('nav.signup')}
            </button>
