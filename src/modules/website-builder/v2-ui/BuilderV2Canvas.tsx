...
import type { Device,WebsiteElement,WebsiteElementType,WebsiteSection } from '../core/types';
...
interface BuilderV2CanvasProps {
...
export function BuilderV2Canvas({
  addElementToSection,
