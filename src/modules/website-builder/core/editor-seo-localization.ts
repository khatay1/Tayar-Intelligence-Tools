...
const arSeoPhrases: Record<string, string> = {
  'Page SEO': 'تحسين SEO للصفحة', 'Search, social sharing and structured data': 'البحث والمشاركة الاجتماعية والبيانات المنظمة',
  ...
  'Web page': 'صفحة ويب', 'About page': 'صفحة من نحن', 'Contact page': 'صفحة تواصل', 'Article': 'مقال', 'Product': 'منتج', 'FAQ page': 'صفحة الأسئلة الشائعة',
  'Prevent search indexing': 'منع فهرسة محركات البحث', 'Do not follow links': 'عدم تتبع الروابط', 'Save SEO': 'حفظ SEO', 'recommended': 'موصى به',
};
const svSeoPhrases: Record<string, string> = {
  'Page SEO': 'Sid-SEO', 'Search, social sharing and structured data': 'Sök, social delning och strukturerad data',
  ...
  'Web page': 'Webbsida', 'About page': 'Om-sida', 'Contact page': 'Kontaktsida', 'Article': 'Artikel', 'Product': 'Produkt', 'FAQ page': 'FAQ-sida',
  'Prevent search indexing': 'Förhindra sökindexering', 'Do not follow links': 'Följ inte länkar', 'Save SEO': 'Spara SEO', 'recommended': 'rekommenderat',
};
