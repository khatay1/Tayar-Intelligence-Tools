...
export const EDITOR_LEFT_PANEL_REGISTRY: EditorPanelRegistration[] = [
  ...
  { id: 'templates', label: 'Templates', order: 60, shortcut: '6' },
  { id: 'components', label: 'Components', order: 70, shortcut: '7' },
  { id: 'site', label: 'Site', order: 80, shortcut: '8' },
  { id: 'settings', label: 'Settings', order: 90, shortcut: '9' },
  { id: 'history', label: 'History', order: 100, shortcut: '0' },
];
