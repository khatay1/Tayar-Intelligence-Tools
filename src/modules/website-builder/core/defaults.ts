...
function normalizeElementContainer(container: Partial<WebsiteElementContainer>, index: number): WebsiteElementContainer {
  ...
  return {
    ...
    rowGap: container.rowGap === undefined ? undefined : number(container.rowGap, 16, 0, 80),
    columns: container.columns === undefined ? undefined : number(container.columns, 2, 1, 12),
