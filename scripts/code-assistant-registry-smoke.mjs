...
if (!assistant.includes('PRIVATE_DIRECTORY_INPUT_PROPS') || !assistant.includes("l('Folder')") || !assistant.includes('{...PRIVATE_DIRECTORY_INPUT_PROPS}')) fail('Private folder import is missing.');
