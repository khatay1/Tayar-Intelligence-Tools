...
check('Template sync requires admin and validates every external hop', templateMirrorSync.includes('requireUser(req)') && templateMirrorSync.includes("profile.role !== 'admin'") && templateMirrorSync.includes("redirect: 'manual'") && templateMirrorSync.includes('assertAllowedSourceUrl'));
