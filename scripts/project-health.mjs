...
check('Website Builder AI edit prompt returns targeted patch operations', aiPrompts.includes("action === 'edit'") && aiPrompts.includes('update_section|add_section|remove_section|update_page|restyle_site|update_site|update_seo|update_header|generate_image') && aiPrompts.includes('Do not return a full "pages" replacement in edit mode'));
