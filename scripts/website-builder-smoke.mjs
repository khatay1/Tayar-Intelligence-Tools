...
check('AI builder duplicates content without reusing source identities', builder.includes("duplicate_page") && builder.includes("duplicate_section") && builder.includes("duplicate_element") && builder.includes('cloneElementForAI') && builder.includes('symbolId: undefined') && editorCommandAdapters.includes('createCollisionSafeCloneIdFactory'));
