...
check('Exact patch review resolves safely when stopped or project lifecycle changes', builder.includes('aiPatchReviewResolverRef.current?.(false)') && builder.indexOf('resolveAIPatchReview(false);', builder.indexOf('function stopAIRequest()')) < builder.indexOf('aiAbortControllerRef.current?.abort()', builder.indexOf('function stopAIRequest()')) && builder.includes('function requestAIPatchReview'));
