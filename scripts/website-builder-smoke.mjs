...
check('Canvas exposes measured multi-element alignment and equal-gap distribution', builder.includes('function arrangeSelectedElements(') && builder.includes('arrangeCanvasElements(measured.map') && existsSync(resolve(root, 'src/modules/website-builder/core/editor-arrangement.ts')) && builder.includes('getBoundingClientRect()') && builder.includes("'Align selected elements'"));
