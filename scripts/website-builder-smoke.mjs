...
check('Element palette uses progressive disclosure', builder.includes("Add Element") && builder.includes("<details"));
...
check('AI builder is optional by default', builder.includes("AI Website Builder") && builder.includes("Optional"));
