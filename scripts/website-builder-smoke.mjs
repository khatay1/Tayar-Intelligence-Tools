...
check('Canvas exposes measured multi-element alignment and equal-gap distribution', builder.includes('function arrangeSelectedElements(') && builder.includes("action === 'distribute-horizontal'") && builder.includes("action === 'distribute-vertical'") && builder.includes('getBoundingClientRect()') && builder.includes("'Align selected elements'"));
